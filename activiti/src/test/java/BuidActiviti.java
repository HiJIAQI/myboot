...
public class BuidActiviti {
    ...
    public void buidActivitiTable() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/demo_activiti?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&rewriteBatchedStatements=true&nullCatalogMeansCurrent=true");
